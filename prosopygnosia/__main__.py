    ...
    while True:
        ...
        if optionMenu == "1":
            ...
            input("Welcome to the help section. \n You must teach this program which of your friends is relationed with"
                  ...
                  "people from the cam.\n\n"
                  "4. This option is for train the actual dataset  (\"/profiledata/*\")\n\n"
                  "5. This option is for add a new user saving a face from the webcam\n\n"
                  "6. Live emotion identification\n\n"
